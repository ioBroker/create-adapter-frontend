...
class App extends Component {
    ...
    renderStepProperties() {
        ...
        return [
            ...
            // use connection indicator as state
            (<FormControlLabel
                className={this.props.classes.paddingTop}
                control={
                    <Checkbox
                        checked={this.state.answers.connectionIndicator}
                        onChange={(e, checked) => this.updateAnswers('connectionIndicator', checked)}
                    />
                }
                label={`Create connection indicator "info.connection"`}
            />),
